...
if(isset($_POST['submit'])) {
    ...
    if($result->num_rows>0) {
        $row = mysqli_fetch_assoc($result);#window.open("https://script.google.com/a/macros/bmsce.ac.in/s/AKfycbwd3hsQpdqi2YMqNP5sOYLwglK3QouDSn8404w5QOaGB18akVFGRQ41cEwsT8PQ_tFL/exec");
		header("Location: https://script.google.com/macros/s/AKfycbw88IpTNer1g5XW1hLu6TUoK8gh1uMI3Ci3_Y6WusCOS4f84BFEOuWX7ndpSDrUHopR/exec");
	} else {
            ...
            <div class="d-flex justify-content-center" style="margin-bottom:10%;">
                <form action="" method="POST" enctype="multipart/form-data" id="log-form">
                    ...
                    <div class="form-row my-4">
                        <div class="col">
                            <input type="text" required name="email" id="email" class="form-control"  value ="<?php echo $name; ?>" placeholder="Name" required autocomplete="off" style="background-color:#ffffff;">
                        </div>
                    </div>
