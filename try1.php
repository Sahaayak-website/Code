...
if(isset($_POST[$ran])){
	...
	$message="Dear ".$name.", we Are pleased To hear that the helper ".$fname." ".$lname." has completed your service with service id " .$req. ". Kindly fill out the feedback form to confirm the same.
	https://docs.google.com/forms/d/e/1FAIpQLSetqbuKGZIIbK35NMlP_C_33mA0M5zmrZLaY2E79MFwUBKwdw/viewform?usp=sf_link";
