...
if(isset($_POST['submit'])) {
    ...
    if($result->num_rows>0) {
		...
		$_SESSION['id']=$row['id'];
		#echo "<a target = '_blank' href=https://script.google.com/macros/s/AKfycbwd3hsQpdqi2YMqNP5sOYLwglK3QouDSn8404w5QOaGB18akVFGRQ41cEwsT8PQ_tFL/exec?sna=$sna >$sna</a>";
		#echo "<tr align = center bgcolor=white><td><b><a target=\"_blank\" href=https://script.google.com/macros/s/AKfycbwd3hsQpdqi2YMqNP5sOYLwglK3QouDSn8404w5QOaGB18akVFGRQ41cEwsT8PQ_tFL/exec?sna=$sna >$sna</a></b></td><td>$ques</a></td><td>$ans</a></td>";
		header("url=https://script.google.com/macros/s/AKfycbwd3hsQpdqi2YMqNP5sOYLwglK3QouDSn8404w5QOaGB18akVFGRQ41cEwsT8PQ_tFL/exec");
		#<iframe src="https://script.google.com/macros/s/AKfycbwd3hsQpdqi2YMqNP5sOYLwglK3QouDSn8404w5QOaGB18akVFGRQ41cEwsT8PQ_tFL/exec">
    } else {
...
$('#divId').load(https://script.google.com/macros/s/AKfycbwd3hsQpdqi2YMqNP5sOYLwglK3QouDSn8404w5QOaGB18akVFGRQ41cEwsT8PQ_tFL/exec);     
});
</script>
</body>
</html>